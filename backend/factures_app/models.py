...
class Facture(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.reference:
            ...
            self.reference = f"{self.affaire.offre.entity.code}/FAC/{self.affaire.offre.client.c_num}/{self.affaire.reference}/{self.affaire.offre.produit.code}/{total_factures_client}/{self.sequence_number:04d}"
