                ...
                {affaires.map((affaire) => (
                  <TableRow 
                    ...
                    className={cn(
                      ...
                      affaire.en_retard ? "bg-red-50 dark:bg-red-950/20 hover:bg-red-100 dark:hover:bg-red-950/30" : ""
                    )}
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Progress 
                          ...
                          className={cn(
                            "h-2 w-20",
                            affaire.progression >= 100 ? "bg-green-200 dark:bg-green-950" : "",
                            affaire.en_retard ? "bg-red-200 dark:bg-red-950" : ""
                          )}
                        />
