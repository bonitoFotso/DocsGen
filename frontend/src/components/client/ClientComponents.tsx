    ...
    <CardContent className="p-4">
      <div className="flex justify-between items-start mb-2">
        ...
        <div className="flex items-center gap-2">
          {status && (
            <Badge variant={statusColor as string || "default"}>{status}</Badge>
          )}
          {date && (
    ...
    <CardContent className="p-4">
      <div className="flex items-start justify-between mb-2">
        <div>
          ...
          {site.code && (
            <div className="text-sm text-muted-foreground">Code: {site.code}</div>
          )}
        </div>
        {site.statut && (
          <Badge variant={statusColor(site.statut) as any}>
            {site.statut}
          </Badge>
        )}
      </div>
