    ...
    >
      <TabsList className="grid grid-cols-8 mb-6">
        <TabsTrigger value="opportunites" className="flex items-center gap-2">
          ...
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.opportunites}</span>
        </TabsTrigger>
        
        <TabsTrigger value="offres" className="flex items-center gap-2">
          <FileText className="h-4 w-4" />
          <span className="hidden sm:inline">Offres</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.offres}</span>
        </TabsTrigger>
        
        <TabsTrigger value="affaires" className="flex items-center gap-2">
          <Briefcase className="h-4 w-4" />
          <span className="hidden sm:inline">Affaires</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.affaires}</span>
        </TabsTrigger>
        
        <TabsTrigger value="contacts" className="flex items-center gap-2">
          <User className="h-4 w-4" />
          <span className="hidden sm:inline">Contacts</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.contacts}</span>
        </TabsTrigger>
        
        <TabsTrigger value="sites" className="flex items-center gap-2">
          <MapPin className="h-4 w-4" />
          <span className="hidden sm:inline">Sites</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.sites}</span>
        </TabsTrigger>
        
        <TabsTrigger value="factures" className="flex items-center gap-2">
          <Receipt className="h-4 w-4" />
          <span className="hidden sm:inline">Factures</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.factures}</span>
        </TabsTrigger>
        
        <TabsTrigger value="formations" className="flex items-center gap-2">
          <Building className="h-4 w-4" />
          <span className="hidden sm:inline">Formations</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.formations}</span>
        </TabsTrigger>
        
        <TabsTrigger value="rapports" className="flex items-center gap-2">
          <Phone className="h-4 w-4" />
          <span className="hidden sm:inline">Rapports</span>
          <span className="text-xs bg-muted rounded-full px-2 py-0.5">{tabCounts.rapports}</span>
        </TabsTrigger>
      </TabsList>
